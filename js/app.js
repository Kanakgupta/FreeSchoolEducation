...
(function (global) {
  ...
  function renderHome() {
    ...
    app.innerHTML = h([
      "<section class='hero'>",
        "<h1>Free, personalized learning for every student</h1>",
        "<p>A comprehensive K\u201312 curriculum across five subjects. Pick a subject or grade and start practicing \u2014 every skill has unlimited interactive questions.</p>",
